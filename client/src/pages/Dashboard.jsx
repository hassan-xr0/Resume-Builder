    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          <button onClick={()=>{setShowCreateResume(true)}} className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-400 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
          ...
          <button className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-400 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
        ...
        {showCreateResume && (
          <form  className="fixed inset-0 bg-black/70 backdorp-blur bg-opacity-50 z-10 flex items-center justify-center" onClick={()=>{setShowCreateResume(false)}} onSubmit={createResume}>
